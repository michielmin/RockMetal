...
The physical model is a simple three-layered structure with an iron core, a silicate mantle and a water/ice top-layer.
The values of f_core and f_ice can be set to compute the radius corresponding to a given mass.
...
f_ice: this is the ratio between the ice layer and the total mass of the planet
